...
def create(request):
    if request.method == 'POST':
        data = {
            ...
            'Pictures': [{'url': request.POST.get('url') or 'https://vafloc01.s3.amazonaws.com/WBStatic/site1100783/dist/img/default-t.png'}],
...
def delete(request, movie_id):
    try:
        ...
        messages.warning(request, 'Got an error when trying to delte a movie: {}'.format(e))
